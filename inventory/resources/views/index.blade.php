                ...
                <div class="contact-list nicescroll">
                    <ul class="list-group contacts-list">
                        ...
                        <li class="list-group-item">
                            <a href="#">
                                <div class="avatar">
                                    <img src="{{ asset('admin/images/users/avatar-5.jpg') }}" alt="">
                                </div>
                        ...
                        <li class="list-group-item">
                            <a href="#">
                                <div class="avatar">
                                    <img src="{{ asset('admin/images/users/avatar-6.jpg') }}" alt="">
                                </div>
                        ...
                        <li class="list-group-item">
                            <a href="#">
                                <div class="avatar">
                                    <img src="{{ asset('admin/images/users/avatar-7.jpg') }}" alt="">
                                </div>
                        ...
                        <li class="list-group-item">
                            <a href="#">
                                <div class="avatar">
                                    <img src="{{ asset('admin/images/users/avatar-8.jpg') }}" alt="">
                                </div>
                        ...
                        <li class="list-group-item">
                            <a href="#">
                                <div class="avatar">
                                    <img src="{{ asset('admin/images/users/avatar-9.jpg') }}" alt="">
                                </div>
                        ...
                        <li class="list-group-item">
                            <a href="#">
                                <div class="avatar">
                                    <img src="{{ asset('admin/images/users/avatar-10.jpg') }}" alt="">
                                </div>
